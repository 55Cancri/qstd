...
│   └── preset/       # Panda preset
│
├── examples/         # Test files (not published)
...
1. **Examples folder:**
   ...
   ```bash
   # Edit examples/test-all.ts to test your new function
...
- [ ] Test files run: `pnpx tsx examples/test-all.ts`
...
2. **Use examples/** - Keep test files there, run with `pnpx tsx`
